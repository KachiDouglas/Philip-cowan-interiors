const TRAINING_PAGE_DATA = {
  ...
  "foundation": {
    "overview": {
      "introduction": "The Foundation Training Assessment is a prerequisite program designed to evaluate and certify new employees on essential entry-level skills before advancing to station-specific or core production training. This assessment covers critical areas such as interpreting instructions, understanding fabrics, accurate measuring, and workplace safety.",
